			...
			<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    <ul class="pagemeta">
                        ...
                        <li><i class="fa fa-comment"></i><?php printf( _n( '%1$s Comment', '%1$s Comments', get_comments_number(), 'parallel' ), esc_html_e(number_format_i18n( get_comments_number() )), get_the_title() ); ?></a></li>
